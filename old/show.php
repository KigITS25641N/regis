...
echo '<table border="1">';
echo '<tr class="gt"><th>NO</th><th>ID</th><th>NAME</th><th>gende</th></th><th>class</th><th>deprment</th><th>faculty</th><th>ลบ</th><th>แก้ไข</th></tr>';
$i=0;
while($row=mysql_fetch_array($result)) {
      ...
      echo '</th><th>';
      echo '<a href="./edit.php?id='.$row['no'].'" >แก้ไข</a></th></tr>';
      $i++;
  }
echo "</table>";
