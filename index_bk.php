  ...
  <font size="10">รับข้อมูล</font><br><br>
        <form action="insert.php" method="post" onsubmit="return myFunction()" enctype="multipart/form-data">
                  ...
                  <br><br>
                  รูปภาพ :: <input type="file" name="fileField" value="myValue" accept=".jpg" id="fileField">
                  <br><br>
